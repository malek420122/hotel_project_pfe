...
test('receptionniste dashboard full journey', async ({ page }) => {
  ...
  await expect(page.locator('h1.dashboard-title')).toHaveText(/File d'attente/i)
  ...
  await expect(page.locator('h1.dashboard-title')).toHaveText(/Check-In/i)
  await expect(page.getByText('Check-ins du jour')).toBeVisible()
  await expect(page.getByText(String(reservationCheckin._id))).toBeVisible()

  await page.goto('/dashboard/receptionniste/checkout')
  await expect(page).toHaveURL(/\/dashboard\/receptionniste\/checkout/)
  await expect(page.locator('h1.dashboard-title')).toHaveText(/Check-Out/i)
  await expect(page.getByText("Check-outs du jour")).toBeVisible()
  ...
  await expect(page.locator('h1.dashboard-title')).toHaveText(/Grille chambres/i)
  ...
  await expect(page.locator('h1.dashboard-title')).toHaveText(/Demandes spéciales/i)
